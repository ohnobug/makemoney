...
// tabbar的快速停止动作
class MyTabbarFastStopScrollPhysics extends ScrollPhysics {
  const MyTabbarFastStopScrollPhysics({super.parent});

  @override
  MyTabbarFastStopScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return MyTabbarFastStopScrollPhysics(parent: buildParent(ancestor));
  }
