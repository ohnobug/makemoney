...
var index = function (props) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.ljn_list_area }, show ? (list.map(function (item, index) {
        return (react_1["default"].createElement(react_native_1.View, { style: styles.ljn_list_item, key: index, onTouchEnd: function () {
