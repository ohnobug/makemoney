...
function index(_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.container },
        react_1["default"].createElement(react_native_1.ScrollView, { directionalLockEnabled: true, horizontal: false, style: styles.ljn_main, scrollEnabled: scrollEnabled },
            react_1["default"].createElement(react_native_1.View, { style: styles.ljn_big_box },
