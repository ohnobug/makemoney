...
var index = function (props) {
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      ...
      react_1["default"].createElement(
        react_native_1.View,
        { style: styles.ljn_login_title },
        react_1["default"].createElement(
          react_native_1.Text,
          { style: styles.ljn_login_title_text },
          "\u6CE8\u518C/\u767B\u5F55\u60A8\u7684\u8D26\u53F7"
        )
      ),
      react_1["default"].createElement(
        react_native_1.View,
        { style: styles.ljn_login_form_area },
        ...
        react_1["default"].createElement(
          react_native_1.View,
          { style: styles.ljn_login_form },
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_login_form_row1 },
          ...
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_login_form_row2 },
          ...
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_login_form_row3 },
            react_1["default"].createElement(LJNLink_1["default"], {
              title: "\u5BC6\u7801\u767B\u5F55",
      ...
      react_1["default"].createElement(LJNLineTitle_1["default"], {
        title: "其他方式",
      }),
      react_1["default"].createElement(
        react_native_1.View,
        { style: styles.ljn_other_login_style },
        react_1["default"].createElement(
          react_native_1.TouchableOpacity,
          { activeOpacity: 0.6, style: styles.ljn_other_login_style_item },
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_other_login_logo },
          ...
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_other_login_title },
            react_1["default"].createElement(
              react_native_1.Text,
              { style: styles.ljn_other_login_title_text },
              "Facebook"
            )
          )
        ),
      ...
      react_1["default"].createElement(
        react_native_1.View,
        { style: styles.ljn_tips_text },
        react_1["default"].createElement(
          react_native_1.Text,
          { style: styles.ljn_user_tips_text },
          "\u7EE7\u7EED\u6CE8\u518C\u5373\u4EE3\u8868\u540C\u610F"
        ),
        react_1["default"].createElement(LJNLink_1["default"], {
          title: "\u300A\u7528\u6237\u534F\u8BAE\u300B",
