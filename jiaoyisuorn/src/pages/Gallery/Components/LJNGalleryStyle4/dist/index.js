...
var index = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.ljn_gallery_list },
        react_1["default"].createElement(react_native_1.View, { style: styles.ljn_gallery_list_side },
        ...
        react_1["default"].createElement(react_native_1.View, { style: styles.ljn_gallery_list_middle },
            react_1["default"].createElement(react_native_1.Image, { style: styles.ljn_gallery_list_middle_image, source: {
                    uri: gallery[2].image
                } })),
        react_1["default"].createElement(react_native_1.View, { style: styles.ljn_gallery_list_side },
            react_1["default"].createElement(react_native_1.View, { style: styles.ljn_gallery_item },
