  ...
  var makeData = function (n) {
    return new Array(n).fill("").map(function () {
      ...
      if (react_native_1.Platform.OS === "web") {
        ...
        exampleImageUri = react_native_1.Image.resolveAssetSource(
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(LJNScrollView_1["default"], {
      ...
      children: react_1["default"].createElement(
        ...
        null,
        new Array(20).fill(0).map(function (item, index) {
          var r = 1 + ~~(Math.random() * 4);
          if (r === 1) {
            return react_1["default"].createElement(
              LJNGalleryStyle1_1["default"],
              { gallery: makeData(6), key: index }
            );
          } else if (r === 2) {
            return react_1["default"].createElement(
              LJNGalleryStyle2_1["default"],
              { gallery: makeData(5), key: index }
            );
          } else if (r === 3) {
            return react_1["default"].createElement(
              LJNGalleryStyle3_1["default"],
              { gallery: makeData(5), key: index }
            );
          } else if (r === 4) {
            return react_1["default"].createElement(
              LJNGalleryStyle4_1["default"],
              { gallery: makeData(5), key: index }
            );
          }
        })
