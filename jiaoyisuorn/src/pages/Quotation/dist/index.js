...
function index(_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.container },
        react_1["default"].createElement(react_native_1.View, { style: {
            ...
            react_1["default"].createElement(react_native_1.Text, { style: { fontSize: utils_1.px2vw(50), color: "red" } },
                "\u5F53\u524D\u4E3B\u9898",
                theme)),
        react_1["default"].createElement(react_native_1.View, { style: styles.ljn_main },
            react_1["default"].createElement(react_native_1.View, { style: {
                ...
                react_1["default"].createElement(react_native_1.Text, { style: { fontSize: utils_1.px2vw(30), color: "red" } }, "\u9ED1\u8272\u4E3B\u9898")),
            react_1["default"].createElement(react_native_1.View, { style: {
                    flex: 1,
                ...
                react_1["default"].createElement(react_native_1.Text, { style: { fontSize: utils_1.px2vw(30), color: "red" } }, "\u767D\u8272\u4E3B\u9898"))),
