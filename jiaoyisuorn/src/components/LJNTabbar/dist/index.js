...
var index = function (props) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.ljn_tabbar }, tabs.map(function (item, index) {
        return (react_1["default"].createElement(react_native_1.TouchableOpacity, { activeOpacity: 0.6, style: styles.ljn_tabbar_item, key: index, onPress: function () {
                dispatch(SystemSlice_1.setTabbarIndex(index));
                navigate(item.path);
            } },
            react_1["default"].createElement(react_native_1.View, { style: styles.ljn_tabbar_item_img_area },
                react_1["default"].createElement(react_native_1.Image, { style: styles.ljn_tabbar_item_img, source: item.icon })),
            react_1["default"].createElement(react_native_1.View, { style: styles.ljn_tabbar_item_title_area },
