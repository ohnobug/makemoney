...
var index = function (_a, ref) {
  ...
  var _c = react_1.useState(0),
    ...
    setActiveIndex = _c[1];
  // tabs 底部蓝色
  var springLeft = react_1.useRef(
    new react_native_1.Animated.Value(9.6)
  ).current;
  var springWidth = react_1.useRef(
    new react_native_1.Animated.Value(26.8)
  ).current;
  // 蓝块滑动
  ...
  var change = function (index, callfunction) {
    ...
    if (item) {
      ...
      if (value < 0) value = 0;
      (_a = myScrollView.current) === null || _a === void 0
        ? void 0
        : _a.scrollTo({
            x: value,
            animated: true,
  ...
  return react_1["default"].createElement(LJNScrollView_1["default"], {
