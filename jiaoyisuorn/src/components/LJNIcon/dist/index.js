...
var index = function (_a) {
    var title = _a.title, _b = _a.size, size = _b === void 0 ? 20 : _b, _c = _a.color, color = _c === void 0 ? "" : _c;
    var theme = hooks_1.useAppSelector(SystemSlice_1.selectTheme);
    var _d = react_1.useState(color), IconColor = _d[0], setIconColor = _d[1];
    ...
    return react_1["default"].createElement(iconfont_1["default"], { name: title, size: size, color: IconColor });
};
