...
let IconXitongfanhui: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconXitongfanhui.defaultProps = {
  size: 18,
};

IconXitongfanhui = React.memo ? React.memo(IconXitongfanhui) : IconXitongfanhui;

export default IconXitongfanhui;
