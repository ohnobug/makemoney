    ...
    return {
      ...
      onPanResponderMove: (e, gesture) => {
        this.props.onPanResponderMove &&
          this.props.onPanResponderMove(e, gesture);
        // ------------------------------------------------------------
        let nu = Animated.event(
          [
            null,
            this.props.vertical
              ? { dy: this.state.pan.y }
      ...
      onPanResponderRelease: (e, gesture) => {
        this.props.onPanResponderRelease &&
          this.props.onPanResponderRelease(e, gesture);
        // ------------------------------------------------------------
        this._fixRelease(e, gesture);
      },
      onPanResponderTerminate: (e, gesture) => {
        this.props.onPanResponderTerminate &&
          this.props.onPanResponderTerminate(e, gesture);
        // ------------------------------------------------------------
        this._fixRelease(e, gesture);
      },
    };
