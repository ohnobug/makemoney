...
COLOR_MAP = {
    ...
    (255, 0, 0, 0): "Theme.of(context).colorScheme.onSurface",
    ...
    (222, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent87",
    (185, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent73",
    (162, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent64",
    (127, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent50",
    (120, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent47",
    (115, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent45",
    (105, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent41",
    (102, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent40",
    (71, 0, 0, 0): "AppTheme.of(context).colorScheme.onSurfaceTransparent28",
