...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: 'change_email',
          pageBuilder: (c, s) => buildPageWithAnimation(
            child: const VigaModifyEmailPage(),
          ),
        ),
        GoRoute(
        ...
        GoRoute(
          path: 'more_secure_setting',
          pageBuilder: (c, s) => buildPageWithAnimation(
            child: const VigaMoreSecureSettingPage(),
          ),
        ),
        GoRoute(
          path: 'sound_lock',
          pageBuilder: (c, s) => buildPageWithAnimation(
            child: const VigaSoundLockPage(),
          ),
        ),
        GoRoute(
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) {
        final args = state.extra as Map<String, dynamic>? ?? {};
        return buildPageWithFadeAnimation(
...
// 视频查看器专用的淡入淡出动画
CustomTransitionPage buildPageWithFadeAnimation<T>({required Widget child}) {
  return CustomTransitionPage<T>(
    child: child,
    transitionDuration: const Duration(milliseconds: 300),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
