  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/settings/account_info':
        return _pageRouteBuilderAnimation(const LJNAccountInfoPage()); // 账号信息页面
      case '/settings/change_account':
        return _pageRouteBuilderAnimation(
            const LJNChangeAccountPage()); // 切换账号页面
      case '/settings/phone_number':
        return _pageRouteBuilderAnimation(const LJNPhoneNumberPage()); // 手机号码页面
      ...
      case '/settings/sound_lock':
        return _pageRouteBuilderAnimation(const LJNSoundLockPage()); // 声音锁页面
      ...
      case '/settings/about':
        return _pageRouteBuilderAnimation(const LJNAboutPage()); // 关于页面
      ...
      // 通讯录相关路由
      case '/contact':
        return _pageRouteBuilderAnimation(const LJNContactPage()); // 通讯录主页面
      case '/contact/tags':
        return _pageRouteBuilderAnimation(const LJNContactTagsPage()); // 标签管理页面
      ...
      case '/contact/group':
        return _pageRouteBuilderAnimation(const LJNContactGroupPage()); // 群组页面
      case '/contact/friends_who_only_chat':
        return _pageRouteBuilderAnimation(
            const LJNFriendsWhoOnlyChatPage()); // 仅聊天朋友页面
      case '/contact/new_friends':
        return _pageRouteBuilderAnimation(const LJNNewFriendsPage()); // 新朋友页面
      case '/contact/search_friend':
        return _pageRouteBuilderAnimation(
            const LJNSearchFriendPage()); // 搜索朋友页面
      ...
      case '/chat/dial':
        return _pageRouteBuilderNotAnimation(const LJNDialPage()); // 拨号页面
      ...
      case '/discovery/search':
        return _pageRouteBuilderNotAnimation(const LJNSearchPage()); // 发现搜索页面
      case '/discovery/ins':
        return _pageRouteBuilderAnimation(const LJNInsPage()); // 朋友圈页面
