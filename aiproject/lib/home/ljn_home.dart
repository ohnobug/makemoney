...
import 'package:jiaoyishuoflutter3/discovery/ljn_home_miniprogram.dart';
...
class LJNHome extends StatefulWidget {
  const LJNHome({super.key});

  @override
  State<LJNHome> createState() => _ChatListViewState();
}

class _ChatListViewState extends State<LJNHome> with TickerProviderStateMixin {
