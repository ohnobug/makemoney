...
class _LJNChatPage extends State<LJNChatPage>
  ...
  void _gotoPositionEmojiPanel({
    ...
    _emojiSelectorAnimationContentController.animateTo(1,
        duration: duration ??
            Duration(milliseconds: _showKeyboradDurationMilliseconds));
  }
      ...
      return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              // 视频通话弹窗
              if (_showDialSelector) _buildVideoCallPopupWidget(systemState)
            ],
          ));
    });
  }
                    ...
                    children: [
                      ...
                      leftRight != 0
                          ? Positioned(
                              ...
                              child: SizedBox(
                                ...
                                height:
                                    _voiceTextBoxHeightAnimation.value + 10.w,
                                child: Stack(
                                  children: [
                                    // 转换后的文字
                                    Container(
                      ...
                      Positioned(
                          ...
                          child: Transform.rotate(
                            ...
                            child: Opacity(
                                opacity:
                                    0.5 + _voiceLottieController.value * 0.5,
                                child: Container(
                                  width: 135.w *
                                      _voiceLeftButtonScaleAnimation.value,
                                  height: 135.w *
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius:
                                        BorderRadius.circular(135.w), // 圆角半径
                                  ),
                                  child: Icon(
                                    const IconData(
                                      0xe628,
                          ...
                          child: Transform.rotate(
                            ...
                            child: Opacity(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        _voiceRightButtonColorAnimation.value,
                                    borderRadius:
                                        BorderRadius.circular(135.w), // 圆角半径
                                  ),
                                  child: Icon(
  ...
  // 视频通话弹窗
  Widget _buildVideoCallPopupWidget(SystemState systemState) {
