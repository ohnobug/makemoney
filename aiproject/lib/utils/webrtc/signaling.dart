...
class Signaling {
  ...
  void onMessage(message) async {
    ...
    switch (mapData['type']) {
      ...
      case 'keepalive':
        {
          logger.info('keepalive response!');
        }
        break;
      default:
        break;
  ...
  Future<void> connect() async {
    ...
    _socket?.onClose = (int? code, String? reason) {
      logger.info('Closed by server [$code => $reason]!');
  ...
  Future<Session> _createSession(
    ...
    pc.onIceCandidate = (candidate) async {
      if (candidate == null) {
        logger.info('onIceCandidate: complete!');
        return;
      }
