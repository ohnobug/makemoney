...
class VigaPaymentDemoPage extends StatelessWidget {
  const VigaPaymentDemoPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentCard(
              ...
              onTap: () => VigaPaymentLauncher.quickStartPayment(context),
            ),
            ...
            _buildPaymentCard(
              ...
              onTap: () => VigaPaymentLauncher.startPaymentFlow(
                context,
                amount: 99.99,
                merchantName: '高级会员服务',
              ),
