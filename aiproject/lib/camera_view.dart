...
class LJNCameraView extends StatefulWidget {
  final List<CameraDescription> cameras;

  /// Default Constructor
  const LJNCameraView({super.key, required this.cameras});

  @override
  State<LJNCameraView> createState() {
    return _LJNCameraViewState();
  }
}
...
class _LJNCameraViewState extends State<LJNCameraView>
