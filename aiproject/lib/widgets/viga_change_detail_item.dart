...
class VigaChangeDetailItem extends StatefulWidget {
  final String icon;
  final String title;
  final String link;
  final double change;
  ...
  @override
  State<VigaChangeDetailItem> createState() => _VigaChangeDetailItemState();
}

// =========================================================================
// ====================    这里是完整的、修正后的 State 类    ====================
// =========================================================================
class _VigaChangeDetailItemState extends State<VigaChangeDetailItem> {
