// /lib/widgets/viga_miniprogram_button.dart
...
class VigaMiniprogramButton extends StatefulWidget {
  final String icon;
  final String title;
  final VoidCallback onPressed;

  const VigaMiniprogramButton({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  VigaMiniprogramButtonState createState() => VigaMiniprogramButtonState();
}

class VigaMiniprogramButtonState extends State<VigaMiniprogramButton> {
