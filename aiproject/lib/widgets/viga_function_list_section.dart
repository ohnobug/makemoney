...
class VigaFunctionListSection extends StatelessWidget {
  final String title;
  final String moreUrl;
  final List<VigaChatListItem> chatItems;

  const VigaFunctionListSection({
    super.key,
    required this.title,
...
// --- 小程序列表项 (已修正) ---
class VigaChatListItem extends StatefulWidget {
  final String avatar;
  final String friendName;
  final String message;
  final Function()? onPressed;

  const VigaChatListItem({
    super.key,
  ...
  @override
  State<VigaChatListItem> createState() => _ChatListItemState();
}

class _ChatListItemState extends State<VigaChatListItem> {
