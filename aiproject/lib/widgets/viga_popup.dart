...
class VigaPopup extends StatefulWidget {
  final Function? onReturn;

  const VigaPopup({super.key, this.onReturn});

  @override
  State<VigaPopup> createState() => _VigaPopupState();
}

class _VigaPopupState extends State<VigaPopup> {
