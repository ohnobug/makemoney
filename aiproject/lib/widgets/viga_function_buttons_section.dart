// /lib/widgets/viga_function_buttons_section.dart
...
class VigaFunctionButtonsSection extends StatelessWidget {
  final String? title;
  final List<VigaFunctionButton> buttons;
  final Widget? rightWidget;
  final String? moreUrl;

  const VigaFunctionButtonsSection({
    super.key,
