...
class VigaIconFunctionItem extends StatefulWidget {
  final String avatar;
  final String title;
  ...
  @override
  State<VigaIconFunctionItem> createState() => _VigaIconFunctionItem();
}

class _VigaIconFunctionItem extends State<VigaIconFunctionItem> {
