// /lib/widgets/viga_function_button.dart
...
class VigaFunctionButton extends StatefulWidget {
  final String icon;
  final String title;
  final VoidCallback onPressed;

  const VigaFunctionButton({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  VigaFunctionButtonState createState() => VigaFunctionButtonState();
}

class VigaFunctionButtonState extends State<VigaFunctionButton> {
