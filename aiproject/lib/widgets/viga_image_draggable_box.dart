...
// 可拖动和缩放的图片框状态组件。
class VigaImaeDraggableBox extends StatefulWidget {
  ...
  @override
  State<VigaImaeDraggableBox> createState() => _VigaImaeDraggableBoxState();
}

class _VigaImaeDraggableBoxState extends State<VigaImaeDraggableBox>
