// /lib/widgets/ljn_miniprogram_button.dart
...
class LJNMiniprogramButton extends StatefulWidget {
  final String icon;
  final String title;
  final VoidCallback onPressed;

  const LJNMiniprogramButton({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  LJNMiniprogramButtonState createState() => LJNMiniprogramButtonState();
}

class LJNMiniprogramButtonState extends State<LJNMiniprogramButton> {
