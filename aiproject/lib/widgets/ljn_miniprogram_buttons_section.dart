// /lib/widgets/ljn_miniprogram_buttons_section.dart
...
class LJNMiniprogramButtonsSection extends StatelessWidget {
  final String? title;
  final List<LJNMiniprogramButton> buttons;
  final Widget? rightWidget;
  final String? moreUrl;

  const LJNMiniprogramButtonsSection(
      {super.key,
