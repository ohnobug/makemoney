...
import 'viga_user_model.dart';

class VigaFollowersListPage extends StatefulWidget {
  const VigaFollowersListPage({super.key});

  @override
  State<VigaFollowersListPage> createState() => _VigaFollowersListPageState();
}

class _VigaFollowersListPageState extends State<VigaFollowersListPage> {
