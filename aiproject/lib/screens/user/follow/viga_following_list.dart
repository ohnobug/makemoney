...
class VigaFollowingListPage extends StatefulWidget {
  const VigaFollowingListPage({super.key});

  @override
  State<VigaFollowingListPage> createState() => _VigaFollowingListPageState();
}

class _VigaFollowingListPageState extends State<VigaFollowingListPage> {
