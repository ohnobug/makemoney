...
// [更正] 类名已修正为 VigaCourseDetailPage
class VigaCourseDetailPage extends StatefulWidget {
  final String courseId;
  const VigaCourseDetailPage({super.key, required this.courseId});

  @override
  State<VigaCourseDetailPage> createState() => _VigaCourseDetailPageState();
}

// [更正] State 类名已修正
class _VigaCourseDetailPageState extends State<VigaCourseDetailPage>
