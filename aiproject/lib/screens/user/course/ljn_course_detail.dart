...
// [更正] 类名已修正为 LJNCourseDetail
class LJNCourseDetail extends StatefulWidget {
  final String courseId;
  const LJNCourseDetail({super.key, required this.courseId});

  @override
  State<LJNCourseDetail> createState() => _LJNCourseDetailState();
}

// [更正] State 类名已修正
class _LJNCourseDetailState extends State<LJNCourseDetail>
