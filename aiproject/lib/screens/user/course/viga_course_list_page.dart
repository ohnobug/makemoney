...
class VigaCourseListPage extends StatefulWidget {
  const VigaCourseListPage({super.key});

  @override
  State<VigaCourseListPage> createState() => _VigaCourseListPageState();
}

// [更正] State 类名已修正
class _VigaCourseListPageState extends State<VigaCourseListPage> {
