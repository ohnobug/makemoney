...
// [更正] 类名已修正为 LJNLessonContentPage
class LJNLessonContentPage extends StatefulWidget {
  final String lessonId;
  const LJNLessonContentPage({super.key, required this.lessonId});

  @override
  State<LJNLessonContentPage> createState() => _LJNLessonContentPageState();
}

// [更正] State 类名已修正
class _LJNLessonContentPageState extends State<LJNLessonContentPage> {
  LessonItem? _lesson;
