...
// [更正] 类名已修正为 LJNLessonContent
class LJNLessonContent extends StatefulWidget {
  final String lessonId;
  const LJNLessonContent({super.key, required this.lessonId});

  @override
  State<LJNLessonContent> createState() => _LJNLessonContentState();
}

// [更正] State 类名已修正
class _LJNLessonContentState extends State<LJNLessonContent> {
  LessonItem? _lesson;
