...
class _LikedVideosPageState extends State<LikedVideosPage> {
  ...
  Future<void> _loadInitialData() async {
    ...
    final List<_LikedVideo> initialVideos = [
      _LikedVideo(timestamp: now.subtract(const Duration(hours: 1)), thumbnailUrl: 'assets/images/avatar/chat_2.jpg', duration: '01:07', title: '《快乐星球》老顽童爷爷赵克明去世...', author: '森森说八卦', viewCount: '9.2万次播放'),
