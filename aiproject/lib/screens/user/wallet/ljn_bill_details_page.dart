...
class LJNBillDetailsPage extends StatefulWidget {
  const LJNBillDetailsPage({super.key});

  @override
  State<LJNBillDetailsPage> createState() => _LJNBillDetailsPage();
}

class _LJNBillDetailsPage extends State<LJNBillDetailsPage>
