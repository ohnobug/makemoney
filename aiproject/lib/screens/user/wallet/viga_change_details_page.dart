...
class VigaChangeDetailsPage extends StatefulWidget {
  const VigaChangeDetailsPage({super.key});

  @override
  State<VigaChangeDetailsPage> createState() => _VigaChangeDetailsPage();
}

class _VigaChangeDetailsPage extends State<VigaChangeDetailsPage> {
  @override
  void initState() {
    super.initState();
  }
