...
class VigaUserMoreInfoPage extends StatefulWidget {
  const VigaUserMoreInfoPage({
    super.key,
  });

  @override
  State<VigaUserMoreInfoPage> createState() => _VigaUserMoreInfoPage();
}

class _VigaUserMoreInfoPage extends State<VigaUserMoreInfoPage> {
  @override
  void initState() {
    super.initState();
  }
