...
class VigaRegisterPage extends StatefulWidget {
  const VigaRegisterPage({super.key});

  @override
  State<VigaRegisterPage> createState() => _VigaRegisterPage();
}

class _VigaRegisterPage extends State<VigaRegisterPage> {
