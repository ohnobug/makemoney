...
class VigaLoginPage extends StatefulWidget {
  const VigaLoginPage({super.key});

  @override
  State<VigaLoginPage> createState() => _VigaLoginPageState();
}

class _VigaLoginPageState extends State<VigaLoginPage> {
