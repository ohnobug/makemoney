...
class VigaCameraViewPage extends StatefulWidget {
  /// Default Constructor
  const VigaCameraViewPage({super.key});

  @override
  State<VigaCameraViewPage> createState() {
    return _VigaCameraViewPageState();
  }
}
...
class _VigaCameraViewPageState extends State<VigaCameraViewPage>
