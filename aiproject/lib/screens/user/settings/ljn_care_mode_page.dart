...
class LJNCareModePage extends StatefulWidget {
  const LJNCareModePage({super.key});

  @override
  State<LJNCareModePage> createState() => _LJNCareModePage();
}

class _LJNCareModePage extends State<LJNCareModePage> {
