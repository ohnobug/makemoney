...
class LJNSoundLockPage extends StatefulWidget {
  const LJNSoundLockPage({super.key});

  @override
  State<LJNSoundLockPage> createState() => _LJNSoundLockPage();
}

class _LJNSoundLockPage extends State<LJNSoundLockPage> {
