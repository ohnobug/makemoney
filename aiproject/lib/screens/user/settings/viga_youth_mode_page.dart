...
class VigaYouthModePage extends StatefulWidget {
  const VigaYouthModePage({super.key});

  @override
  State<VigaYouthModePage> createState() => _VigaYouthModePage();
}

class _VigaYouthModePage extends State<VigaYouthModePage> {
