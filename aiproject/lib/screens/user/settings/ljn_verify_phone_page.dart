...
class LJNVerifyPhonePage extends StatefulWidget {
  const LJNVerifyPhonePage({super.key});

  @override
  State<LJNVerifyPhonePage> createState() => _LJNVerifyPhonePage();
}

class _LJNVerifyPhonePage extends State<LJNVerifyPhonePage> {
  bool isHide = true;
