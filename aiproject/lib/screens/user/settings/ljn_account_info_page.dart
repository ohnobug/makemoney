...
class LJNAccountInfoPage extends StatefulWidget {
  const LJNAccountInfoPage({super.key});

  @override
  State<LJNAccountInfoPage> createState() => _LJNAccountInfoPage();
}

class _LJNAccountInfoPage extends State<LJNAccountInfoPage> {
  @override
  void initState() {
    super.initState();
  }
