...
class VigaEmergencyContactPage extends StatefulWidget {
  const VigaEmergencyContactPage({super.key});

  @override
  State<VigaEmergencyContactPage> createState() => _LJEemergencyContact();
}

class _LJEemergencyContact extends State<VigaEmergencyContactPage> {
