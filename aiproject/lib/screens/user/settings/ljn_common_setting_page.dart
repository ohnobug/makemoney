...
class LJNCommonSettingPage extends StatefulWidget {
  const LJNCommonSettingPage({super.key});

  @override
  State<LJNCommonSettingPage> createState() => _LJNCommonSettingPage();
}

class _LJNCommonSettingPage extends State<LJNCommonSettingPage> {
  @override
  void initState() {
    super.initState();
  }
