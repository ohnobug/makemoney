...
class LJNDeviceDetailPage extends StatefulWidget {
  const LJNDeviceDetailPage({super.key});

  @override
  State<LJNDeviceDetailPage> createState() => _LJNDeviceDetailPage();
}

class _LJNDeviceDetailPage extends State<LJNDeviceDetailPage> {
  @override
  void initState() {
    super.initState();
  }
