...
class LJNLanguageSettingPage extends StatefulWidget {
  const LJNLanguageSettingPage({super.key});

  @override
  State<LJNLanguageSettingPage> createState() => _LJNLanguageSettingPageState();
}

class _LJNLanguageSettingPageState extends State<LJNLanguageSettingPage> {
  // 定义所有支持的语言列表
