...
class LJNChatSettingPage extends StatefulWidget {
  const LJNChatSettingPage({super.key});

  @override
  State<LJNChatSettingPage> createState() => _LJNChatSettingPage();
}

class _LJNChatSettingPage extends State<LJNChatSettingPage> {
  @override
  void initState() {
    super.initState();
  }
