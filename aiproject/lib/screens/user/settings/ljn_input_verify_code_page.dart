...
class LJNInputVerifyCodePage extends StatefulWidget {
  const LJNInputVerifyCodePage({super.key});

  @override
  State<LJNInputVerifyCodePage> createState() => _LJNInputVerifyCodePage();
}

class _LJNInputVerifyCodePage extends State<LJNInputVerifyCodePage> {
  bool isHide = true;
