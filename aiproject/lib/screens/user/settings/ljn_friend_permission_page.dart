...
class LJNFriendPermissionPage extends StatefulWidget {
  const LJNFriendPermissionPage({super.key});

  @override
  State<LJNFriendPermissionPage> createState() => _LJNFriendPermissionPage();
}

class _LJNFriendPermissionPage extends State<LJNFriendPermissionPage> {
  @override
  void initState() {
    super.initState();
  }
