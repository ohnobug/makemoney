...
class VigaChangeAccountPage extends StatefulWidget {
  const VigaChangeAccountPage({super.key});

  @override
  State<VigaChangeAccountPage> createState() => _VigaChangeAccountPage();
}

class _VigaChangeAccountPage extends State<VigaChangeAccountPage> {
