...
class LJNSetPasswordPage extends StatefulWidget {
  const LJNSetPasswordPage({super.key});

  @override
  State<LJNSetPasswordPage> createState() => _LJNSetPasswordPageState();
}

class _LJNSetPasswordPageState extends State<LJNSetPasswordPage> {
