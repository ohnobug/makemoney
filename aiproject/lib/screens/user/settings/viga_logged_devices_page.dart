...
class VigaLoggedDevicesPage extends StatefulWidget {
  ...
  @override
  State<VigaLoggedDevicesPage> createState() => _VigaLoggedDevicesPage();
}

class _VigaLoggedDevicesPage extends State<VigaLoggedDevicesPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<VigaSystemCubit, SystemState>(
      builder: (context, systemState) {
        ...
        return Scaffold(
          primary: false,
          appBar: VigaAppBar(title: l10n.loggedInDevices, actions: [
            GestureDetector(
              onTap: () {
