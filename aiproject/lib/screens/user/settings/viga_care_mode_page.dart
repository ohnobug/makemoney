...
class VigaCareModePage extends StatefulWidget {
  const VigaCareModePage({super.key});

  @override
  State<VigaCareModePage> createState() => _VigaCareModePage();
}

class _VigaCareModePage extends State<VigaCareModePage> {
