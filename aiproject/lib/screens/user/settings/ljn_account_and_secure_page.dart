...
class LJNAccountAndSecurePage extends StatefulWidget {
  const LJNAccountAndSecurePage({super.key});

  @override
  State<LJNAccountAndSecurePage> createState() => _LJNAaccountAndSecure();
}

class _LJNAaccountAndSecure extends State<LJNAccountAndSecurePage> {
  @override
  void initState() {
    super.initState();
  }
