...
class VigaAboutPage extends StatefulWidget {
  const VigaAboutPage({super.key});

  @override
  State<VigaAboutPage> createState() => _VigaAbout();
}

class _VigaAbout extends State<VigaAboutPage> {
