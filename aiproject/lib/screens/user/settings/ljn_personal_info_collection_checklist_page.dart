...
class LJNPersonalInfoCollectionChecklistPage extends StatefulWidget {
  const LJNPersonalInfoCollectionChecklistPage({super.key});

  @override
  State<LJNPersonalInfoCollectionChecklistPage> createState() =>
      _LJPpersonalInfoCollectionChecklist();
}

class _LJPpersonalInfoCollectionChecklist
    extends State<LJNPersonalInfoCollectionChecklistPage> {
  @override
  void initState() {
    super.initState();
  }
