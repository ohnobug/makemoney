...
class LJNPersonalinfoAndPermissionPage extends StatefulWidget {
  const LJNPersonalinfoAndPermissionPage({super.key});

  @override
  State<LJNPersonalinfoAndPermissionPage> createState() =>
      _LJNPersonalinfoAndPermissionPage();
}

class _LJNPersonalinfoAndPermissionPage
    extends State<LJNPersonalinfoAndPermissionPage> {
  @override
  void initState() {
    super.initState();
  }
