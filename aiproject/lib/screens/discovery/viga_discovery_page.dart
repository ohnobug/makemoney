...
class VigaDiscoveryPage extends StatefulWidget {
  const VigaDiscoveryPage({super.key});
...
class _VigaDiscoveryPageState extends State<VigaDiscoveryPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<VigaSystemCubit>().updateMainpage2isload(true);
      }
    });
  }
