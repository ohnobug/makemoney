...
class _LJNSearch extends State<LJNSearch> {
  ...
  void initState() {
    ...
    // 抖音热榜标题
    hotListTitles = [
      AppLocalizations.of(context)!.douyinHotTrends,
      AppLocalizations.of(context)!.cityHotTrends,
      AppLocalizations.of(context)!.liveHotTrends,
      AppLocalizations.of(context)!.groupBuyHotTrends,
      AppLocalizations.of(context)!.brandHotTrends,
      AppLocalizations.of(context)!.musicHotTrends,
      AppLocalizations.of(context)!.techHotTrends,
      AppLocalizations.of(context)!.autoHotTrends,
      AppLocalizations.of(context)!.idiotList,
      AppLocalizations.of(context)!.richList,
      AppLocalizations.of(context)!.prankList,
      AppLocalizations.of(context)!.horrorList,
      AppLocalizations.of(context)!.kidsList,
      AppLocalizations.of(context)!.goodPersonList,
      AppLocalizations.of(context)!.badPersonList,
      AppLocalizations.of(context)!.rockList,
      AppLocalizations.of(context)!.movieList,
      AppLocalizations.of(context)!.tvSeriesList
    ];
      ...
      return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            height: 90.w,
            color: AppColors.neutralWhite, // 设置背景颜色
            child: Row(
  ...
  Widget hotListWidget(List<Widget> hotList) {
    // 获取当前的语言代码，例如 "zh" 或 "en"
    final locale = Localizations.localeOf(context).toString();

    // 这是你要格式化的原始数字
    final double number = 12012000;

    // 使用 NumberFormat.compact 来创建格式化工具
    // 它会根据 locale 自动选择单位
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: Center(
                child: Text(
                  AppLocalizations.of(context)!.viewFullList,
