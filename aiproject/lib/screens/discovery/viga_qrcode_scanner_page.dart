...
class VigaQRCodeScanner extends StatefulWidget {
  const VigaQRCodeScanner({super.key});

  @override
  State<VigaQRCodeScanner> createState() => _VigaQRCodeScannerState();
}

class _VigaQRCodeScannerState extends State<VigaQRCodeScanner> {
  // 音频播放器
  ...
  void initState() {
    ...
    _mobileScannerController.barcodes.listen((BarcodeCapture barcodeCapture) {
      ...
      if (mounted) {
        ...
        final screenSize = context.read<VigaSystemCubit>().state.screenSize;

        List<Offset> pointCenter = [];
        for (var barcode in barcodes) {
          pointCenter.add(
            _getPointPosition(barcode.corners, BoxFit.cover,
            ...
            children: [
              ...
              Visibility(
                ...
                child: Expanded(
                  ...
                  child: Center(
                    child: SizedBox(
                      // color: AppColors.redTransparent76,
                      height: 690.w,
                      width: 640.w,
                      child: Stack(
                        children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            height: 90.w,
                            decoration: const BoxDecoration(
                              color: AppColors.greyTransparent31,
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppColors.greyTransparent59,
        ...
        GestureDetector(
          onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Circle Clicked!  ${widget.rawValue}'),
              ),
            );
          },
          child: Container(
