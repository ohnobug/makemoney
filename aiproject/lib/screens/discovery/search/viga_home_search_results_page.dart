...
class VigaHomeSearchResultsPage extends StatefulWidget {
  ...
  @override
  State<VigaHomeSearchResultsPage> createState() =>
      _VigaHomeSearchResultsPageState();
}
        ...
        children: [
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      context.pushReplacement('/home_search_results', extra: {
          ...
          Expanded(
            child: VigaWorkSearchWidget(
              ...
              initialSourceId: widget.initialSearchType == 'author_search'
                  ? 'works'
                  : 'works',
    ...
    switch (widget.initialSearchType) {
      case 'contact_search':
        ...
        sources.add(SearchSource(
          ...
          suggestionsBuilder: () =>
              ['工作群', '同学群', '兴趣群', '家庭群', '项目群', '游戏群', '学习群', '交流群'],
        ));
        break;
      ...
      default:
        ...
        sources.add(SearchSource(
          ...
          suggestionsBuilder: () =>
              ['摄影师', '美食博主', '旅行达人', '健身教练', '音乐人', '游戏主播', '时尚达人', '手工艺人'],
        ));
        ...
        sources.add(SearchSource(
          ...
          suggestionsBuilder: () =>
              ['工具类', '游戏类', '教育类', '生活类', '娱乐类', '购物类', '社交类', '新闻类'],
        ));
        break;
    }
  ...
  List<WorkItem> _generateGroupsData() {
    return List.generate(
        ...
        (i) => WorkItem(
              ...
              createTime: DateTime.now()
                  .subtract(Duration(days: Random().nextInt(180))),
            ));
  }
