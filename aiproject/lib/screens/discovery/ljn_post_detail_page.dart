...
// 主页面 Widget
class LJNPostDetailPage extends StatefulWidget {
  final PostDetailData postData;

  const LJNPostDetailPage({
    super.key,
    required this.postData,
  });

  @override
  State<LJNPostDetailPage> createState() => _LJNPostDetailPageState();
}

class _LJNPostDetailPageState extends State<LJNPostDetailPage> {
