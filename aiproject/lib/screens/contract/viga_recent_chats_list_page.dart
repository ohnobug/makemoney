...
import 'package:vigaviga/screens/contract/widgets/viga_chat_miniprogram.dart';
...
class VigaRecentChatsListPage extends StatefulWidget {
  ...
  @override
  State<VigaRecentChatsListPage> createState() => _VigaRecentChatsListPage();
}
...
class _VigaRecentChatsListPage extends State<VigaRecentChatsListPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<VigaSystemCubit>().updateMainpage4isload(true);
    });
