...
class VigaFriendsWhoOnlyChatPage extends StatefulWidget {
  const VigaFriendsWhoOnlyChatPage({super.key});

  @override
  State<VigaFriendsWhoOnlyChatPage> createState() =>
      _VigaFriendsWhoOnlyChatState();
}

class _VigaFriendsWhoOnlyChatState extends State<VigaFriendsWhoOnlyChatPage> {
