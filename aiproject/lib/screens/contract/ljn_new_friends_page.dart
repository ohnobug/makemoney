...
class LJNNewFriendsPage extends StatefulWidget {
  const LJNNewFriendsPage({super.key});

  @override
  State<LJNNewFriendsPage> createState() => _LJNNewFriendsState();
}

class _LJNNewFriendsState extends State<LJNNewFriendsPage> {
