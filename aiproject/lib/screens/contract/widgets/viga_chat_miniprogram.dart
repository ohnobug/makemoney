...
class VigaChatMiniProgram extends StatefulWidget {
  final Function reverse;
  final double homescrollpixels;

  const VigaChatMiniProgram({
    super.key,
  ...
  @override
  State<VigaChatMiniProgram> createState() => _VigaChatMiniProgram();
}

class _VigaChatMiniProgram extends State<VigaChatMiniProgram> {
