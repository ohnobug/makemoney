...
class VigaContactTagsPage extends StatefulWidget {
  const VigaContactTagsPage({super.key});

  @override
  State<VigaContactTagsPage> createState() => _VigaContactTagsState();
}

class _VigaContactTagsState extends State<VigaContactTagsPage> {
  // 列表包含了所有原始数据
