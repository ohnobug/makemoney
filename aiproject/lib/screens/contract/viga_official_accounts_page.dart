...
class VigaOfficialAccountsPage extends StatefulWidget {
  const VigaOfficialAccountsPage({super.key});

  @override
  State<VigaOfficialAccountsPage> createState() => _VigaOfficialAccountsState();
}

class _VigaOfficialAccountsState extends State<VigaOfficialAccountsPage> {
