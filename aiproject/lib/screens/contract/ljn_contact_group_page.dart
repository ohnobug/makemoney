...
class LJNContactGroupPage extends StatefulWidget {
  const LJNContactGroupPage({super.key});

  @override
  State<LJNContactGroupPage> createState() => _LJNContactGroupState();
}

class _LJNContactGroupState extends State<LJNContactGroupPage> {
