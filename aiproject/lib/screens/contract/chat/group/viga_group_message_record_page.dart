...
class VigaGroupMessageRecordPage extends StatefulWidget {
  const VigaGroupMessageRecordPage({
    super.key,
    this.name,
    this.avatar,
    this.nickname,
  ...
  @override
  State<VigaGroupMessageRecordPage> createState() => _VigaGroupMessageRecord();
}

class _VigaGroupMessageRecord extends State<VigaGroupMessageRecordPage> {
  @override
  void initState() {
    super.initState();
  }
