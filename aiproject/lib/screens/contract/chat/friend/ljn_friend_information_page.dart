...
class LJNFriendInformationPage extends StatefulWidget {
  const LJNFriendInformationPage({
    super.key,
  });

  @override
  State<LJNFriendInformationPage> createState() => _LJNFriendInformation();
}

class _LJNFriendInformation extends State<LJNFriendInformationPage> {
  @override
  void initState() {
    super.initState();
  }
