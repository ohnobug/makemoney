...
class LJNFriendPermissionsPage extends StatefulWidget {
  const LJNFriendPermissionsPage({super.key});

  @override
  State<LJNFriendPermissionsPage> createState() => _LJNFriendPermissions();
}

class _LJNFriendPermissions extends State<LJNFriendPermissionsPage> {
  bool chatOnly = false;
