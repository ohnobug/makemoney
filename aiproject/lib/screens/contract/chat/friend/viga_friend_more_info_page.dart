...
class VigaFriendMoreInfoPage extends StatefulWidget {
  const VigaFriendMoreInfoPage({
    super.key,
  });

  @override
  State<VigaFriendMoreInfoPage> createState() => _VigaFriendMoreInfoPage();
}

class _VigaFriendMoreInfoPage extends State<VigaFriendMoreInfoPage> {
  @override
  void initState() {
    super.initState();
  }
