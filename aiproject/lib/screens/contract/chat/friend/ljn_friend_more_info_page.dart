...
class LJNFriendMoreInfoPage extends StatefulWidget {
  const LJNFriendMoreInfoPage({
    super.key,
  });

  @override
  State<LJNFriendMoreInfoPage> createState() => _LJNFriendMoreInfoPage();
}

class _LJNFriendMoreInfoPage extends State<LJNFriendMoreInfoPage> {
  @override
  void initState() {
    super.initState();
  }
