...
class VigaFriendMessageRecordPage extends StatefulWidget {
  const VigaFriendMessageRecordPage({
    super.key,
    this.name,
    this.avatar,
    this.nickname,
  ...
  @override
  State<VigaFriendMessageRecordPage> createState() => _VigaFriendMessageRecord();
}

class _VigaFriendMessageRecord extends State<VigaFriendMessageRecordPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildPage(SystemState systemState) {
    ...
    return Scaffold(
      primary: false,
      appBar: VigaAppBar(title: l10n.chatMessages),
