...
class VigaSetFriendTagsPage extends StatefulWidget {
  const VigaSetFriendTagsPage({
    super.key,
  });

  @override
  State<VigaSetFriendTagsPage> createState() => _VigaSetFriendTags();
}

class _VigaSetFriendTags extends State<VigaSetFriendTagsPage> {
  ...
  Widget _buildPage(BuildContext context, SystemState systemState) {
    ...
    return Scaffold(
      ...
      appBar: VigaAppBar(
        ...
        actions: [
          VigaAppBarActionTextButton(onTap: () {}, title: l10n.save),
        ],
      ),
      body: Container(
