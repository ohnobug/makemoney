...
class LJNFriendMomentsCoverSettingPage extends StatefulWidget {
  const LJNFriendMomentsCoverSettingPage({super.key});

  @override
  State<LJNFriendMomentsCoverSettingPage> createState() =>
      _LJNFriendMomentsCoverSetting();
}

class _LJNFriendMomentsCoverSetting
    extends State<LJNFriendMomentsCoverSettingPage> {
  @override
  void initState() {
    super.initState();
  }
