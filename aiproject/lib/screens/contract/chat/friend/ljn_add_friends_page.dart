...
class LJNAddFriendsPage extends StatefulWidget {
  const LJNAddFriendsPage({
    super.key,
  });

  @override
  State<LJNAddFriendsPage> createState() => _LJNAddFriends();
}

class _LJNAddFriends extends State<LJNAddFriendsPage> {
  @override
  void initState() {
    super.initState();
  }
