...
class VigaMyVoiceMessage extends StatefulWidget {
  const VigaMyVoiceMessage(
      {super.key,
  ...
  @override
  State<VigaMyVoiceMessage> createState() => _VigaMyMessage();
}

class _VigaMyMessage extends State<VigaMyVoiceMessage>
