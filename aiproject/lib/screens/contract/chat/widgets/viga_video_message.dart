...
class VigaVideoMessage extends StatefulWidget {
  const VigaVideoMessage({
    super.key,
    required this.video,
  ...
  @override
  State<VigaVideoMessage> createState() => _VigaVideoMessage();
}

class _VigaVideoMessage extends State<VigaVideoMessage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<VigaSystemCubit, SystemState>(
      builder: (context, systemState) {
        final userState = context.watch<VigaUserCubit>().state;
