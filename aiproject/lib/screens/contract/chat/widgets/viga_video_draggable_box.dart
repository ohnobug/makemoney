...
import 'package:vigaviga/tools/viga_cancelable_delay.dart';
import 'package:video_player/video_player.dart';

class VigaVideoDraggableBox extends StatefulWidget {
  ...
  @override
  State<VigaVideoDraggableBox> createState() => _VigaVideoDraggableBoxState();
}

class _VigaVideoDraggableBoxState extends State<VigaVideoDraggableBox>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<VigaPopupCubit, PopupState>(
  ...
  VigaCancelableDelay? cancelableDelay;
  ...
  void closeFullScreen(Offset currentPosition) {
    ...
    _sizedController.stop();
    canBeCloseFlag = false;
    cancelableDelay = VigaCancelableDelay();
      ...
      (_) {
        ...
        cancelableDelay!.delayed(
          ...
          () {
            setState(
              () {
                context.read<VigaPopupCubit>().updateReturnButtonEvent(false);
                context.read<VigaPopupCubit>().updateShowFullScreenVideo(false);
