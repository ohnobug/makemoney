...
class VigaReceiveVideoMessage extends StatefulWidget {
  const VigaReceiveVideoMessage({
    super.key,
    required this.video,
  ...
  @override
  State<VigaReceiveVideoMessage> createState() => _VigaReceiveVideoMessage();
}

class _VigaReceiveVideoMessage extends State<VigaReceiveVideoMessage> {
