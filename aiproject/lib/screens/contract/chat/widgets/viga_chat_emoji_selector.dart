...
class VigaChatEmojiSelector extends StatefulWidget {
  const VigaChatEmojiSelector({super.key});

  @override
  State<VigaChatEmojiSelector> createState() => _VigaChatEmojiSelector();
}

class _VigaChatEmojiSelector extends State<VigaChatEmojiSelector> {
