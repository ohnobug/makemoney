...
class VigaReceiveMessage extends StatefulWidget {
  const VigaReceiveMessage({
    super.key,
  ...
  @override
  State<VigaReceiveMessage> createState() => _VigaReceiveMessage();
}

class _VigaReceiveMessage extends State<VigaReceiveMessage> {
  @override
