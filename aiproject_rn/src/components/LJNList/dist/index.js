      ...
      return react_1["default"].createElement(
        react_native_1.View,
        {
          style: react_native_1.StyleSheet.flatten([
            ...
            index === props.list.length - 1 ? styles.ljn_list_item_last : null,
          ]),
          key: index,
        },
        react_1["default"].createElement(
          react_native_1.TouchableOpacity,
          { style: styles.ljn_list_item_inner, activeOpacity: 0.6 },
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_list_item_title },
            react_1["default"].createElement(
              react_native_1.Text,
              { style: styles.ljn_list_item_title_text },
              item.title
            )
          ),
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_list_item_desc },
            item.desc
              ? react_1["default"].createElement(
                  react_native_1.Text,
                  { style: styles.ljn_list_item_desc_text },
                  item.desc
                )
              : null
          ),
