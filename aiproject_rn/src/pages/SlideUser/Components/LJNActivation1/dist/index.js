...
var index = function (props) {
  ...
  return react_1["default"].createElement(
    react_native_1.View,
    { style: styles.ljn_activation_box },
    show
      ? react_1["default"].createElement(
          ...
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_activation_header },
            react_1["default"].createElement(
              react_native_1.View,
              { style: styles.ljn_activation_header_left },
              react_1["default"].createElement(
                react_native_1.Text,
                { style: styles.ljn_activation_header_left_title },
                "\u65B0\u624B\u4EFB\u52A1"
              )
            ),
            react_1["default"].createElement(
              react_native_1.View,
              { style: styles.ljn_activation_header_right },
          ...
          react_1["default"].createElement(
            react_native_1.View,
            { style: styles.ljn_activation_main },
            react_1["default"].createElement(
              react_native_1.View,
              { style: styles.ljn_activation_row1 },
            ...
            react_1["default"].createElement(
              react_native_1.View,
              { style: styles.ljn_activation_row2 },
              react_1["default"].createElement(
                react_native_1.Text,
                { style: styles.ljn_activation_row2_text },
                "\u6CE8\u518C\u767B\u5F55\u5373\u53EF\u83B7\u5F97"
              )
            ),
            react_1["default"].createElement(
              react_native_1.View,
              { style: styles.ljn_activation_row3 },
