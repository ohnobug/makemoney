...
var LJNVideoPlayer_1 = require("components/LJNVideoPlayer");
var index = function (_a) {
  ...
  return react_1["default"].createElement(
    react_native_1.View,
    { style: styles.ljn_gallery_list, onLayout: handleLayout },
    react_1["default"].createElement(
      ...
      react_1["default"].createElement(
        ...
        react_1["default"].createElement(LJNVideoPlayer_1["default"], {
    ...
    react_1["default"].createElement(
      ...
      gallery.slice(1).map(function (item, index) {
        return react_1["default"].createElement(
          react_native_1.View,
          { style: styles.ljn_gallery_item, key: index },
