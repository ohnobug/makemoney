...
class Tab extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget _buildLabelText() {
    return child ?? Text(text!, style: TextStyle(fontSize: 12), softWrap: false, overflow: TextOverflow.fade);
  }
    ...
    return MaterialStateColor.resolveWith((Set<MaterialState> states) {
      if (states.contains(MaterialState.selected)) {
        if (animation.value >= 0.5) {
          ...
          return Color.lerp(selectedColor, unselectedColor, animation.value * 2)!;
        }
      }
      ...
      if (animation.value >= 0.5) {
          ...
          return Color.lerp(unselectedColor, selectedColor, animation.value * 2)!;
        }
    });
  }
...
class _IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (showDivider && dividerHeight !> 0) {
      ...
      final Offset dividerP1 = Offset(0, (dividerPaint.strokeWidth / 2));
      final Offset dividerP2 = Offset(size.width, (dividerPaint.strokeWidth / 2));
